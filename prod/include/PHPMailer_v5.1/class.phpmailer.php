 ...
 */
  ...
  */
   ...
   * @return bool
   */
  public function AddAttachment($path, $name = '', $encoding = 'base64', $type = 'application/octet-stream' , $url = false) {
    try {
  ...
  */
  ...
  private function AttachAll() {
    ...
    foreach ($this->attachment as $attachment) {
      ...
      if($bString) {
        ...
        $mime[] = $this->EncodeFile($path, $encoding, $url);
        if($this->IsError()) {
          return '';
        }
        $mime[] = $this->LE.$this->LE;
   ...
   * @return string
   */
  private function EncodeFile($path, $encoding = 'base64', $url=false) {
    try {
