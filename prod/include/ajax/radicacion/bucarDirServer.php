...
class BuscarDirServer extends HTML_AJAX_Server {
  ...
  var $ruta_raiz;
	...
	function initBuscarDir() {
    $ruta_raiz = "../../..";
    //alert("Entro a initUsuarios");
		include 'buscarDir.class.php';
		$this->registerClass(new buscarDir($this->db,$this->ruta_raiz),'buscarDir',array('getBuscarCiuDoc'));
...
$server = new BuscarDirServer();
$server->conexion($db,$ruta_raiz);
$server->initBuscarDir();
