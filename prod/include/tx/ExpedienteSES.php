...
/** Variable 
 ...
 /** Variable 
   * @param $numSubexpediente int Almacena el n�mero de subexpediente;
   */
...
/** 
  ...
  * @return Numero de Expediente que posee el radicado
  * 
  * Modificaci�n: 09-Junio-2006 Supersoldiaria
  * @param  $codiPROC Numeric C�digo del proceso asociado al expediente
  * @param  $arrParametro Array Arreglo que contiene los par�metros asociados al expediente
...
/** 
  ...
  */      
  ...
  /** Descripci�n: FUNCI�N QUE CONSULTA EL TRD DEL EXPEDIENTE SEG�N PARAMETROS SERIE, SUBSERIE, PROCESO Y EXPEDIENTE
    *              Esta funcion devuelve los datos de serie, subserie y proceso asociados al expediente.
    * Par�metros:
    * @param $numExp String N�mero del expediente.
    * @param $codiSrd int C�digo de la serie documental.
    * @param $codiSbrd int C�digo de la subserie documental.
    * @param $codiProc int C�digo del proceso.
    * Retorna:
    * @return $arrTRDExp Arreglo con los datos de serie, subserie y proceso asociados al expediente.
    * Fecha de creaci�n: 13-Junio-2006
    ...
    */
    ...
    /** Descripci�n: FUNCI�N QUE CONSULTA LOS PAR�METROS ASIGANDOS A UN EXPEDIENTE
    * Esta funcion devuelve las etiquetas y los valores asociados a un expediente.
    * Par�metros:
    * @param $numExp String N�mero del expediente.
    * @param $depeCodi int C�digo de la dependencia.
    * Retorna:
    * @return $arrDatosParam Arreglo con la etiqueta y los datos de los par�metros.
    * Fecha de creaci�n: 13-Junio-2006
    * Creador: Supersolidaria
    * Fecha de modificaci�n:
    * Modificador:
  ...
  /** FUNCION EXISTE EXPEDIENTE
    ...
    * @return 0 si no existe el Expediente y el n�mero del Expediente en caso contrario.
    * Fecha de creaci�n: 21-Junio-2006
    * Creador: Supersolidaria
    * Fecha de modificaci�n:
    * Modificador:
    */
  ...
  /** FUNCION EXPEDIENTES RADICADO
    ...
    * @param $radicado int N�mero del radicado incluido en el expediente a buscar.
    * @param $numExpediente int N�mero del expediente a buscar.
  ...
  /** 
    * FUNCI�N EXCLUIR EXPEDIENTE
    * Excluye un N�mero de radicado de un Expediete
    * @param  $radicado int Contiene el numero de radicado a Buscar
    * @param  $numExpediente String N�mero del Expediente del que se desea excluir el radicado.
    * @return 1 si el radicado fue excluido del expediente y 0 en caso contrario.
    * Fecha de creaci�n: 23-Junio-2006
    * Creador: Supersolidaria
    * Fecha de modificaci�n:
    * Modificador:
    */
    ...
    /** 
    * FUNCI�N RADICADO PADRE, ANEXOS y ASOCIADOS
    ...
    * Fecha de creaci�n: 27-Junio-2006
    * Creador: Supersolidaria
    * Fecha de modificaci�n:
    * Modificador:
    */
    ...
    /** 
    * FUNCI�N GRABAR SUBEXPEDIENTE
    * Almacena el n�mero del subexpediente asociado a un expediente y a un radicado.
    * @param  $radicado int Contiene el n�mero de radicado
    * @param  $numExpediente int Contiene el n�mero del expediente
    * @param  $numSubexpediente int Contiene el n�mero del Subexpediente
    * @return 1 si se grab� correctamente el subexpediente y 0 en caso contrario.
    * Fecha de creaci�n: 29-Junio-2006
    * Creador: Supersolidaria
    * Fecha de modificaci�n:
    * Modificador:
    */
