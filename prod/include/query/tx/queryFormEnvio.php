...
switch ($tmp_arr_id) {
    case 1:$tmp_where = " and (i.info_codi is null) ";
        break;
    default:$tmp_where = " ";
        break;
}
            ...
            switch ($tmp_arr_id) {
                case 0: {
                        ...
                        $isql = 'select
							...
							,' . $sqlFecha . '			 as "DAT_Fecha Radicado"
							,b.RADI_NUME_RADI		 as "HID_Numero Radicado"
							,b.sgd_spub_codigo       as "HID_NV"
							,b.RA_ASUN 			     as "Descripcion"
							,c.SGD_TPR_DESCRIP		 as "Tipo Documento"
							,b.RADI_USU_ANTE		 as "Enviado Por"
							,
								CASE b.sgd_spub_codigo 
								WHEN      0 THEN \'P&uacute;blico\'
            					WHEN 	  1 THEN \'Privado\'
            					WHEN 	  2 THEN \'Dependencia\'  
            					WHEN 	  3 THEN \'Usuario especifico\'    
            					END          as "Nivel seguridad"
							,cast(b.RADI_NUME_RADI as varchar(15)) as "CHK_CHKANULAR"
					 from
						radicado b,
					 	SGD_TPR_TPDCUMENTO c
