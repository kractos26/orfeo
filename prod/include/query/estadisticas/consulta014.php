...
if(isset($_GET['genDetalle'])&& $_GET['denDetalle']==1){ 
                $titulos=array("#","1#RADICADO","2#FECHA RADICACI&Oacute;N","3#TIPO DOCUMENTO ","4#RAD PADRE","5#CTA INTERNA","6#N&Uacute;MERO EXPEDIENTE","7#CARPETA PERSONAL","8#USUARIO ACTUAL","9#ASUNTO","10#ESP","11#DIR ESP","12#NOMBRE PERDIO","13#DIRECCI&Oacute;N PREDIO","14#DEPTO PREDIO","MPIO PREDIO");
        }else{           
                $titulos=array("#","1#USUARIO","2#RADICADO");
} 
