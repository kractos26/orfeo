...
/**
* Paggina CuerpoTX.php que muestra Las ultimas Transacciones realizadas por los Usuarios
* Creado x Correlibre en 2011
* Se añadio compatibilidad con variables globales en Off
* @autor Jairo Losada 2011-05
...
if ($swLog==1) 
  ...
  if($orden_cambio==1)
	...
	if ( strlen ( $item ) != 0) {
		if ($entidad != "DNP") {
 	        	$busqRadicadosTmp .= " cast(b.radi_nume_radi as varchar(20)) like '%$item%' or";
		} else {
