...
?>
  <table border=0 width=100% class=borde_tab cellspacing="5">
    ...
    <?
			...
			print $rsEnv->GetMenu2("empresa_envio","$empresa_envio",false, false, 0," class='select' id='empresa_envio' onClick='calcular_precio();'");
   ?>
   </td>
  ...
  $isql = "SELECT a.RADI_NUME_SAL	
    ...
    <tr  class='listado2'>
      <td height="21" colspan="10">Observaciones o Desc Anexos
        ...
        <input name=planilla type=text class='tex_area' value='<?=$planilla?>' size=30 maxlength="30" >
      </td>
