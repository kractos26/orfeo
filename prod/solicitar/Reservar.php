 ...
 *                          solicite un documento f�sico y realiza las 
 *                          actualizaciones relacionadas con el m�dulo de 
...
function verMensaje($nombTx,$fecha) {    
   ...
   $sPRESTAMOErr="no presentar";  //para que solo se haga visible esta funci�n ?>
...
function PRESTAMO_action($sAction) {
   ...
   // Cancelaci�n, prestamo o devoluci�n de un documento
...
function PRESTAMO_show() {
   ...
   if ($sPRESTAMOErr=="") {
      ...
      // Inicializaci�n de la variable que indica si el usuario puede o no hacer solicitudes
      if(!$rs1->EOF) { 
...
?>
               <script>
                  /*Adecua el formulario para que la p�gina regrese a la anterior*/
                  function regresar() {
