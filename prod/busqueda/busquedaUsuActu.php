	...
	{	if ($s_solo_nomb=="All")
		{
			...
			while ($tok)
			{
				if($sWhere != "" && $and=="true")
					$sWhere .= " and ";
				$HasParam = true;
				$sWhere .= " upper(U.USUA_NOMB".$c."R.RA_ASUN) like '%".$tok."%' ";
				$tok = strtok(" ");
				$and="true";
			}
			$sWhere.=")";
...
<tr>
	...
	<td valign="top">
		...
		<a class="vinculos" href="../busqueda/busquedaExp2.php?<?=$phpsession ?>&krd=<?=$krd?>&<? echo "&fechah=$fechah&primera=1&ent=2"; ?>">B&uacute;squeda Expediente</a>
	</td>
</tr>
</table>
<?php
