...
$ADODB_FETCH_MODE = ADODB_FETCH_ASSOC;
    ...
    $objpintar = new PintarFormulario($ruta_raiz);
     $sqlformularios = "SELECT ID,NOMBRE FROM FORMULARIOPQR WHERE ESTADO = 1";
                                ...
                                <div class="col-sm-7">
                                    ...
                                    <div class="col-sm-11">
                                       <?=$objpintar->PintarControles('habeasdata', 3,"habeasdata", "NOMBRE","ID","","0","","",$numformulario)?>  
                                        <a href="http://www2.sgc.gov.co//Servicios-de-informacion-al-ciudadano/Proteccion-de-Datos-Personales/archivos/POLITICA-DE-TRATAMIENTO-Y-PROTECCION-DE-DATOS-PERS.aspx" target="_blank">leer política de tratamiento y protección de datos personales</a>
                                    </div>
