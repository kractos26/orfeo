...
{	include_once($ruta_raiz."/radicacion/crea_combos_universales.php");
	...
	{	$record = array();
        ...
        if ($_POST['btn_accion'] == 'Eliminar')	$record['IDENTIFICADOR_EMPRESA'] = $_POST['sls_idesp'];
...
{	$msg = '<tr bordercolor="#FFFFFF">
	...
	{	case 1:	//NO CONECCION A BD
		...
		case 4:	//INSERCION REALIZADA
				$msg .= "Remitente / Tercero creado satisfactoriamente!!";break;
		case 5:	//IMPOSIBILIDAD DE ELIMINAR ESP, TIENE HISTORIAL, EST? LIGADO CON DIRECCIONES
				$msg .= "No se puede eliminar Remitente / Tercero, se encuentra ligado a un radicado.";break;
	}
	$msg .= '</td></tr>';
}
?>
...
<table width="75%" align="center" border="1" cellspacing="0" class="tablas">
	<tr bordercolor="#FFFFFF">
		<td colspan="6" height="40" class="titulos4" valign="middle" >Administraci&oacute;n de Remitentes / Terceros.</td>
	</tr>
</table>
