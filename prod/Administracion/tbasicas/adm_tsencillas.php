...
if ($conn) {
    ...
    $vec_ppal[5] = array("Motivo Anulaci&oacute;n", "MOTIVO_ANULACION", "MOTIVO_ANULACION_CODIGO", "MOTIVO_ANULACION_DESCRIP");
    $vec_ppal[6] = array("Motivo Modificaci&oacute;n", "MOTIVO_MODIFICACION", "MOTIVO_MODIFICACION_CODIGO","MOTIVO_MODIFICACION_DESCRIP");
    /* POR IMPLEMENTAR
    ...
    switch ($_POST['slc_ppal']) {
        ...
        case 5: {
                include($ruta_raiz . '/include/class/motivo_anulacion.class.php');
                $obj_tmp = new motivo_anulacion($conn);
            }break;
        case 6: {
                include($ruta_raiz . '/include/class/Motivo_modificacion.class.php');
                $obj_tmp = new Motivo_modificacion($conn);
                }break;
        ...
        <form name="form1" method="post" action="<?= $_SERVER['PHP_SELF'] ?>">
            ...
            <table width="75%" border="1" align="center" cellspacing="0" class="tablas">
                ...
                <tr bordercolor="#FFFFFF">
                    ...
                    <td class="listado2"><input name="txtModelo" id="txtModelo" type="text" size="50" maxlength="150"></td>
                </tr>
                <?php
                echo $msg;
                ?>
