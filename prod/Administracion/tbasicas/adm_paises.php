...
*
*	Permite la administraci�n de paises. La inserci�n y modificaci�n hace uso de la funcion
*	Replace de ADODB, la eliminaci�n est� sujeta a que �ste NUNCA haya sido referenciado en radicados.
*/
session_start();
$ruta_raiz = "../..";
...
{	$conn->SetFetchMode(ADODB_FETCH_ASSOC);
	...
	$Rs_cont = $conn->Execute($sql_cont); 	//Query en cache por 24 horas.
	if (!($Rs_cont)) $error = 2;
...
{   document.getElementById('txtModelo').value = '';
    document.getElementById('txtIdPais').value = '';
}
else
{
