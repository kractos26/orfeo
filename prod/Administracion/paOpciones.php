     ...
     <tr> 
       ...
       <td width='50%' align="center" class="titulos2" > 
		<a href='<?=$pagina_sig?>?<?=$encabezado?>'></a>
           <input <?=($accion_sal == "Transladar")?'type=button"':'type=submit'?> <?=($accion_sal == "Transladar")?'onclick="masivaTranspaso();"':'onclick="Marcar(2)";'?> value="<?=$accion_sal?>" name=Enviar id=Enviar valign='middle' class='botones_largo'   >			
       </td>
     </tr>
   </table>
