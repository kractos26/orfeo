...
<table border=1 width=93% class=t_bordeGris align="center">
	...
	<tr class=timparr>
			<td class="titulos2" height="26" width="25%">Serie del Proceso: &nbsp;&nbsp;<font color="Green" size="3"><?=$_SESSION["serieProc"]?></td>
...
<table border=1 width=93% class=t_bordeGris align="center">
	<tr class=timparr>
		  ...
		  <center> <input class="botones" type="button" Value=<?=$nombreBoton?> onClick=" return validarDatos();"> </center> </span> </span></td>
	      <td height="30" colspan="2" class="listado2"><span class="celdaGris"> <span class="e_texto1">
	<center><a href='mnuFlujosBasico.php?<?=session_name()."=".session_id()."&$encabezado"?>'>
	<input class="botones" type=button name=Cancelar id=Cancelar Value=Cancelar></center>  </span> </span></td>
	<td height="30" colspan="2" class="listado2"><span class="celdaGris">
	<center></center>  </span> </span></td>
	</tr>
</table>
<br>
<?
