...
<tr>
 ...
 <td width="60%" class='listado2' ><font size=3>
 	...
 	<table WIDTH="90%" align="center" border="0" cellpadding="0" cellspacing="5" class="borde_tab" >
		<tr bgcolor='#6699cc' class='etextomenu' align='middle'>
 			<td width="80%" class='titulos2' ><center><font size=1> CONEXIONES </center></td>
 			<td width="20%" class='titulos2' ><center><font size=1> Crear 
 			<a  href='javascript:Start("creaArista.php?<?=session_name().'='.session_id().'&$encabezado'?>&proceso=<?=$procesoSelected?>&etapaCreaArista=<?=$codigoEtapa?>",750,600)'><img src="../../../imagenes/add.png" style="border:0"></a>
 				</center></td> 			
		</tr>
		...
		?>
				<tr>
					 ...
					 <td width="10%" class='listado2' ><font size=1>
					 	<center>
 							<input type="image" name="Button" value="Modificar" src="../../../imagenes/modificar.gif" onClick="Start('modificaArista.php?<?=$phpsession ?>&aristaAModificar=<?=$codigoArista?>&proceso=<?=$procesoSelected?>',700,600);">
						</center>
 					</td>
 				</tr>
			<?php
