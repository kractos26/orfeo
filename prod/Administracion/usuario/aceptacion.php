...
<?
	...
	if ($login)
		...
		$isql1 = "select USUA_CODI, DEPE_CODI, USUA_ESTA, USUA_PRAD_TP2, USUA_ADMIN, USUA_ADMIN_ARCHIVO, USUA_NUEVO, CODI_NIVEL, USUA_PRAD_TP1, USUA_MASIVA, USUA_PERM_DEV, SGD_PANU_CODI from USUARIO WHERE USUA_LOGIN = '".$login."'";
		$rs=$db->query($isql1);
		}
