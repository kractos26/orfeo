...
?>  
    ...
    <td align="left" class="vbmenu_control"> <input type="checkbox" name="anulaciones" value="$anulaciones" <? if ($anulaciones) echo "checked"; else echo "";?>> 
      Anulaciones</td>
        ...
        <tr>
    <td align="left" class="vbmenu_control"> <input type="checkbox" name="remitenteTerceros" value="$remitenteTerceros" <? if ($remitenteTerceros) echo "checked"; else echo "";?>> 
      Remitentes / Terceros</td>
    <td align="left" class="vbmenu_control"> <input type="checkbox" name="remitenteTerceros" value="$remitenteTerceros" <? if ($remitenteTerceros) echo "checked"; else echo "";?>> 
      Remitentes / Terceros</td>
	</tr>
