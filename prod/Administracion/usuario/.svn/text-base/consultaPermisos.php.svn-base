...
?>
        ...
        <tr>
            <td width="40%" height="26" class="listado2">
                <input disabled type="checkbox" name="$remitenteTerceros" <? if ($remitenteTerceros) echo "checked"; else echo "";?>>
                Remitentes / Terceros
            </td>
            <td width="40%" height="26" class="listado2">
                 <input disabled  type="checkbox" name="ciudadanosempresas" value="1" <? if ($ciudadanosempresas) echo "checked"; else echo ""; ?>>
                     Ciudadanos / Empresas
                 </td>
        </tr>
             <tr>
            <td width="40%" height="26" class="listado2">
                                    <input  disabled  type="checkbox" name="adminispqrs" value="1" <? if($administracionpqr == 1) echo "checked"; else echo ""; ?>>
...
{	$i = 1;
	...
	{	(is_int($i/2)) ? print "" : print "<TR align='left'>";
		...
		while ($x<4)
		{	if($arr['SGD_TRAD_CODIGO']==2 and $x==1)$x=5;
