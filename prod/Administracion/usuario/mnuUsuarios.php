...
<form name='frmMnuUsuarios' action='../formAdministracion.php?<?=session_name()."=".session_id()?>&krd=<?=$krd?>' method="post">
  ...
  <tr bordercolor="#FFFFFF">
    <td colspan="2" class="titulos4"><div align="center"><strong>ADMINISTRACI&Oacute;N DE USUARIOS Y PERFILES</strong></div></td>
  </tr>
  <tr bordercolor="#FFFFFF">
  ...
  <tr bordercolor="#FFFFFF">
    <td align="center" class="listado2" width="98%"><a href='CuerpoTranslado.php?<?=$phpsession ?>&krd=<?=$krd?>&trans=1' class="vinculos" target='mainFrame'>4.Translado de Dependencia </a></td>
  </tr>
  <tr bordercolor="#FFFFFF">
