...
{
    $linkPagina = "$PHP_SELF?BuscarGet=1&$encabezado&serieSel=".$serieSel."&subserieSel=".$subserieSel."&tdocSel=".$tdocSel."&tradSel=".$tradSel."&fechaIniSel=".$_POST['fechaIni']."&fechaInifSel=".$_POST['fechaInif']."&orderTipo=$orderTipo&orderNo=$orderNo";
    $encabezado = "BuscarGet=1&".session_name()."=".session_id()."&fechaIniSel=".$_POST['fechaIni']."&fechaInifSel=".$_POST['fechaInif']."&adodb_next_page=1&krd=$krd&depeBuscada=$depeBuscada&filtroSelect=$filtroSelect&tpAnulacion=$tpAnulacion&carpeta=$carpeta&tipo_carp=$tipo_carp&nomcarpeta=$nomcarpeta&agendado=$agendado&orderTipo=$orderTipo&orderNo=";
}
else if( $_GET['fechaIniSel'] != "" && $_GET['fechaInifSel'] != "" )
{
    $linkPagina = "$PHP_SELF?BuscarGet=1&$encabezado&serieSel=".$serieSel."&subserieSel=".$subserieSel."&tdocSel=".$tdocSel."&tradSel=".$tradSel."&fechaIniSel=".$_GET['fechaIniSel']."&fechaInifSel=".$_GET['fechaInifSel']."&orderTipo=$orderTipo&orderNo=$orderNo";
    $encabezado = "BuscarGet=1&".session_name()."=".session_id()."&fechaIniSel=".$_GET['fechaIniSel']."&fechaInifSel=".$_GET['fechaInifSel']."&adodb_next_page=1&krd=$krd&depeBuscada=$depeBuscada&filtroSelect=$filtroSelect&tpAnulacion=$tpAnulacion&carpeta=$carpeta&tipo_carp=$tipo_carp&nomcarpeta=$nomcarpeta&agendado=$agendado&orderTipo=$orderTipo&orderNo=";
}
...
<form name="sinexp" method='post' action='<?=$_SERVER['PHP_SELF']."?".$encabezado?>'>
<br>
<table border=1 width="70%" class="borde_tab" align="center">
<tr>
	<td class=titulos2 colspan="2">Radicados Archivados Sin Expediente</td>
</tr>
<tr>
...
<tr>
	<td class="titulos5" align="right" >Serie </td>
	<td class='titulos5'>
<?php
...
<tr>
	<td class='titulos5' align="right" > SubSerie </td>
	<td class='titulos5'>
<?php
...
<tr>
	<td class="titulos5" align="right">Fecha Radicado Final</td>
	<td class="titulos5">
	<script language="javascript">
...
<tr>
	...
	<a href='archivo.php?<?=session_name()?>=<?=trim(session_id())?>krd=<?=$krd?>'><input name='Regresar' align="middle" type="button" class="botones" id="envia22" value="Regresar" >
	</td>
</tr>
</table>
<?php
if(isset($_POST['Buscar']) || isset($_GET['BuscarGet']))
{
