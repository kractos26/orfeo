...
<br>
<br>
<a href='<?=$path?>'> <input type="button" class="botones_funcion"
	value="Descargar" name="descargar"></a><?
	...
	?><select id='caja'>
	<option value='not'>-- Selecione --</option><?php
	echo $option;
	?></select><?php
...
<body>
<center>
<table class="borde_tab" class="borde_tab" bgcolor="#ffffff">
	<tr>
		<td colspan="6" class="titulos4">Formato Unico de Inventario
		Documental</td>
	</tr>
	<tr>
		<td class="titulos2">Edificio</td>
		<td class="titulos2"><select id="edificio"
			onchange='CAJAS("combopiso");'>
...
<?php
	...
	?></select></td>
		...
		<td class="titulos2">
		<div id="combopiso"><select id="piso">
			<option value='not'>-- Selecione --</option>
		</select></div>
		</td>
	</tr>
	<tr>
		<td class="titulos2">Area</td>
		<td class="titulos2">
		<div id="comboarea"><select id="area">
			<option value='not'>-- Selecione --</option>
		</select></div>
		</td>
		<td class="titulos2">Modulo</td>
		<td class="titulos2">
		<div id="combomodulo"><select>
			<option value='not'>-- Selecione --</option>
		</select></div id="modulo">
		</td>
	</tr>
	<tr>
		<td class="titulos2">Estante</td>
		<td class="titulos2">
		<div id="comboestante"><select id="estante">
			<option value='not'>-- Selecione --</option>
		</select></div>
		</td>
		<td class="titulos2" colspan=2 align="center"><input type="submit"
			class="botones" onclick='planilla("estructura","estante");'
			value="Generar Estante" name="Buscar"></td>
	</tr>
	<tr>
		<td class="titulos2">Entrepa&ntilde;o</td>
		<td class="titulos2">
		<div id="comboentre"><select>
			<option value='not'>-- Selecione --</option>
		</select></div id="entre">
		</td>
		<td class="titulos2" colspan=2 align="center"><input type="submit"
			class="botones" onclick='planilla("estructura","entre");'
			value="Generar Entrepa&ntilde;o" name="Buscar"></td>
	</tr>
	<tr>
		<td class="titulos2">Caja</td>
		<td class="titulos2">
		<div id="combocaja"><select id="caja">
			<option value='not'>-- Selecione --</option>
		</select></div>
		</td>
		<td class="titulos2" colspan=2 align="center"><input type="submit"
			class="botones" onclick='planilla("estructura","caja");'
			value="Generar Caja" name="Buscar"></td>
	</tr>
