...
<tr>
	...
	<td width="20%" class='titulos2'><input type=text name=buscar_orden value='<?=$buscar_orden?>' class="tex_area"></td>
...
<tr>
	...
	<td width="20%" class='titulos2'><input type=text name=buscar_demant value='<?=$buscar_demant?>' class="tex_area" ></td>
</tr>
<tr>
	<td width="20%" class='titulos2' align="left"> FECHA INICIAL &nbsp;&nbsp;&nbsp;&nbsp;  Desde  <br>&nbsp;&nbsp;&nbsp;
<?php
...
<tr>
	<td width="20%" class='titulos2' align="left">OBSERVACIONES </td>
	<td width="20%" class='titulos2'><input type=text name=anexo value='<?=$anexo?>' class="tex_area">
<?php
switch($codserie)
{
	case '300': $proc=1;break;
  	default: $proc=2;break;
}
?>
	</td>
...
?>
	...
	<td width="20%" class='titulos2' align="left">DOCUMENTO DE IDENTIDAD</td>
	<td width="20%" class='titulos2'><input type=text name=buscar_docu value='<?=$buscar_docu?>' class="tex_area"></td>
</tr>
<tr>
