...
<tr><td class=titulosError  width="80%" colspan="4" align="center">BUSQUEDA AVANZADA (SOLO PARA RADICADOS ARCHIVADOS) </td></tr>
<tr>
...
$querySerie = "select distinct ($sqlConcat) as detalle, s.sgd_srd_codigo from sgd_mrd_matrird m,
 	sgd_srd_seriesrd s where s.sgd_srd_codigo = m.sgd_srd_codigo and TO_DATE('".$fecha_hoy."','YYYY-MM-DD') between s.sgd_srd_fechini
 	and s.sgd_srd_fechfin order by detalle ";
$rsD=$db->conn->Execute($querySerie);
$comentarioDev = "Muestra las Series Docuementales";
include "$ruta_raiz/include/tx/ComentarioTx.php";

echo "".$rsD->GetMenu2('codserie',$codserie,"0:-- Seleccione --", false,""," id='codserie' onChange='submit()' class='select'");

?>
</td>
	<td width="20%" class='titulos2' align="left">EXPEDIENTE</td>
	<td width="20%" class='titulos2'>
		<input type=text name=buscar_exp value='<?=$buscar_exp?>' class="tex_area">
	</td>
</tr>
<tr>
...
$querySub = "select distinct ($sqlConcat) as detalle, su.sgd_sbrd_codigo from sgd_mrd_matrird m,
	...
	and su.sgd_sbrd_codigo = m.sgd_sbrd_codigo and TO_DATE('".$fecha_hoy."','YYYY-MM-DD') between su.sgd_sbrd_fechini
...
?>
	...
	<td width="20%" class='titulos2'><input type=text name=buscar_rad value='<?=$buscar_rad?>' class="tex_area"></td>
</tr>
<tr>
	<td width="20%" class='titulos2' align="left">PROCESO </td>
	<td width="20%" class='titulos2' colspan="3">
<?php
...
?>	
	...
	<td width="20%" class='titulos2'><input type=text name=buscar_parametros value='<?=$buscar_parametros?>' class="tex_area"></td>
	 -->
</tr>

<tr>
	<td width="20%" class='titulos2' align="left">
		NOMBRE O ASUNTO DEL EXPEDIENTE

	</td>
	<td width="20%" class='titulos2'>
		<input type=text name=buscar_docu value='<?=$buscar_docu?>' size="20" class="tex_area">
		
	<td width="20%" class='titulos2'>EDIFICIO </td>
	<td width="20%" class='titulos2' >
<?php
$sql5="select SGD_EIT_SIGLA,SGD_EIT_CODIGO from SGD_EIT_ITEMS where SGD_EIT_COD_PADRE ISNULL ";
$rs=$db->query($sql5);
...
<tr>
	<td width="20%" class='titulos2' align="left"><?=$item1?> </td>
    <td width="20%" class='titulos2'>
    <!--input type=text name=buscar_isla value='<?=$buscar_piso?>' class="tex_area" size=3 maxlength="2"></td-->
<?php
...
<td width="20%" class='titulos2' align="left"> FECHA ARCHIVO &nbsp;&nbsp;&nbsp;&nbsp;  Desde  <br>&nbsp;&nbsp;&nbsp;
	...
	<br>&nbsp;
	<script language="javascript">
	var dateAvailable2 = new ctlSpiffyCalendarBox("dateAvailable2", "busqueda_archivo", "fechaInif","btnDate2","<?=$fechaInif?>",scBTNMODE_CUSTOMBLUE);
...
<td width="20%" class='titulos2' align="left">FASE DEL EXPEDIENTE </td>
<?
...
<TD class=titulos5 >NOMBRE
<TD class=titulos5 >ASUNTO
...
if($buscar_rad!=""){$r="cast(e.RADI_NUME_RADI as varchar) LIKE '%$buscar_rad%'";$b="and";$perm2=1;}
else {$r="";$b="";}
if($codserie!='0'){$srds="cast(s.SGD_SRD_CODIGO as varchar) LIKE '$codserie'";$c="and";$perm2=1;}
else {$srds="";$c="";}
if($codiSBRD!='0'){$sbrds="cast(s.SGD_SBRD_CODIGO as varchar) LIKE '$codiSBRD'";$d="and";$perm2=1;}
else {$sbrds="";$d="";}
if($codProc!='0'){$pross="s.SGD_PEXP_CODIGO LIKE '$codProc'";$ef="and";$perm2=1;}
else{$pross="";$ef="";}
if($buscar_ufisica!=""){
if($item2=="ENTREPANO" or $item2=="ENTREPANO"){$ufisica="cast(e.SGD_EXP_ENTREPA as varchar) LIKE '$buscar_ufisica'";$t3="and";}
elseif($item2=="CAJA"){$ufisica="e.SGD_EXP_CAJA LIKE '$buscar_ufisica'";$t3="and";}
}
else {$ufisica="";$t3="";}
if($buscar_estan!=""){
if($item3=="ENTREPANO" or $item3=="ENTREPANO"){$estan="cast(e.SGD_EXP_ENTREPA as varchar) LIKE '$buscar_estan'";$t2="and";}
elseif($item3=="CAJA"){$estan="e.SGD_EXP_CAJA LIKE '$buscar_estan'";$t2="and";}
}
else {$estan="";$t2="";}
if($buscar_entre!=""){
if($item4=="ENTREPANO" or $item4=="ENTREPANO"){$entre="cast(e.SGD_EXP_ENTREPA as varchar) LIKE '$buscar_entre'";$t1="and";}
elseif($item4=="CAJA"){$entre="e.SGD_EXP_CAJA LIKE '$buscar_entre'";$t1="and";}
}
else {$entre="";$t1="";}
if($buscar_caja!=""){
if($item5=="ENTREPANO" or $item5=="ENTREPANO"){$caja="cast(e.SGD_EXP_ENTREPA as varchar) LIKE '$buscar_caja'";$t="and";}
elseif($item5=="CAJA"){$caja="e.SGD_EXP_CAJA LIKE '$buscar_caja'";$t="and";}
}
else {$caja="";$t="";}
if($buscar_caja2!=""){
if($item6=="ENTREPANO" or $item6=="ENTREPANO"){$caja2="cast(e.SGD_EXP_ENTREPA as varchar) LIKE '$buscar_caja2'";$u1="and";}
...
if ($sep=='1'){
	if($fechaInii==$fechaInif){$fecha="e.SGD_EXP_FECH_ARCH = '$fechaInii'";}
	else{
	$time=fnc_date_calcy($fechaInif,'1');
	$fecha="e.SGD_EXP_FECH_ARCH BETWEEN '".$fechaInii."' AND '".$time."'";
	}
	$perm2=1;
	$i="and";
}
...
if($buscar_rete!=""){$foli="cast(s.SGD_SEXP_FASEEXP as varchar) LIKE '$buscar_rete'";$k="and";$perm2=1;}
else {$foli="";$k="";}
...
$cont=0;
    ...
    $nombreexp=$rs->fields['SGD_SEXP_NOMBRE'];
    $asuntoexp=$rs->fields['SGD_SEXP_ASUNTO'];
	include("$ruta_raiz/include/query/archivo/queryBusqueda_exp.php");
...
//                {
                    ?>
                    <tr>
                    <td class=leidos2 align="center"><a href='../bodega<?=$path?>' > <?=$radi?></a></td>
                    ...
                    <td class=leidos2 align="center"><a href='datos_expediente.php?<?=$encabezado."&num_expediente=$expnum&ent=1&nurad=$radi"?>' class='vinculos'><?=$expnum?></a></td>
                    <td class=leidos2 align="center"><b><span class=leidos2><?=$nombreexp?></span></b></td>
                    <td class=leidos2 align="center"><b><span class=leidos2><?=$asuntoexp?></span></b></td>
                    <td class=leidos2 align="center"><b><span class=leidos2><?=$srd?></span></b></td>
                    <td class=leidos2 align="center"><b><span class=leidos2><?=$sbrd?></span></b></td>
                    <td class=leidos2 align="center"><b><span class=leidos2><?=$proceso?></span></b></td>
                    <td class=leidos2 align="center"><b><span class=leidos2><?=$folios?></span></b></td>
                    <td class=leidos2 align="center"><b><span class=leidos2><?=$nam0?></span></b></td>
                    <td class=leidos2 align="center"><b><span class=leidos2><?=$nam1?></span></b></td>
                    <td class=leidos2 align="center"><b><span class=leidos2><?=$nam2?></span></b></td>
                    <td class=leidos2 align="center"><b><span class=leidos2><?=$nam3?></span></b></td>
                    <td class=leidos2 align="center"><b><span class=leidos2><?=$nam4?></span></b></td>
                    <td class=leidos2 align="center"><b><span class=leidos2><?=$nam5?></span></b></td>
                    <td class=leidos2 align="center"><b><span class=leidos2><?=$nam6?></span></b></td>
                    <td class=leidos2 align="center"><b><span class=leidos2><?=$nam7?></span></b></td>
                    <td class=leidos2 align="center"><b><span class=leidos2><?=$fech?></span></b></td>
                    <td class=leidos2 align="center"><b><span class=leidos2><?=$fechfin?></span></b></td>
                    </tr>
                   <?
                   $cont++;
//                }
