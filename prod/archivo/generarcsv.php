...
if($Gen){
	...
	$archivoc="$ruta_raiz/bodega/tmp/".$archivo.".csv";
	$com = chr(34);
	...
	$fp=fopen($archivoc,"wb");
	fputs($fp,$contenido);
	fclose($fp);
	echo "Para ver el archivo CSV de clic aqui: ";
	?>
	<a href="<?=$archivoc?>"> <?=$archivo?></a>
	<?
}
}
  ...
  <table width="90%" border="0" cellspacing="5" class="borde_tab">
	...
	<td align="center"> <input type="button" value="Cerrar" onClick="window.close();" class="botones_funcion"> </td>
    </tr>
    </table>
