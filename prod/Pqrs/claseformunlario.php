...
class claseformunlario {
    ...
    function updateRadicado($asuntopqr,$tipopqr,$numeroRadicado,$pach)
    {
        $array = array('ASUNTOPQR'=>"'".$asuntopqr."'",'TIPOPQR'=>"'".$tipopqr."'",'RADI_PATH'=>"'".$pach."'",'SGD_APLI_CODIGO'=>1);
    ...
    function asignarMTRD($codigoPqr,$dependencia,$numeroR,$usuariopqr)
        {
         ...
         function enviarcorreo($mensaje,$correo,$rutaPdf,$asunto)
