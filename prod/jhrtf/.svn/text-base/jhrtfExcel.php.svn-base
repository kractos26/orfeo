...
//			$this->validarLugar();
			...
			if($counter < 1){
				echo "<br>";
			die("<span class='etextomenu'>No se encontraron secuencias disponibles para dicha radicaci&oacute;n, es posible que la masiva ya haya sido radicada o que corresponda a otra dependencia. <br>");
