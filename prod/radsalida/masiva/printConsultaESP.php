...
$archivo = "$ruta_raiz/$carpetaBodega/masiva/tmp_$usua_doc"."_$fecha"."_$hora.$salida";
$rutaArchivo = "$ruta_raiz/seguridadImagen.php?fec=".base64_encode("/masiva/tmp_$usua_doc"."_$fecha"."_$hora.$salida");
$esp = & new Esp($db);
        ...
        <input type="hidden" name="params" value="<?=$params?>">
          ...
          <tr align="left" >
            <td height="84" class=listado2 >Se
              ...
              al archivo: <a href="<?=$rutaArchivo?>" target="_blank"><?=strtoupper($salida)?> GENERADO</a>.</td>
          </tr>
		  <tr>
