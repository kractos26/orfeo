...
<span class=tituloListado>Se terminó de realizar la verificación de los archivos 
...
?>
<p class=etexto> <span class='etextomenu'>Al archivo CSV no se le definió correctamente el campo tipo en los registros
  :<BR>
  <?  
