...
if (count($auxErrLugar)>0)  {
  ...
  Los siguientes datos de las direcciones tienen tama&nacute;o mayor de 95 caracteres<BR>
   ...
   $num = count($auxErrorAnexo);
    ...
    if (count($auxErrorDirectorio)>0){
	?>
	El Directorio donde se almacenara el archivo no existe para la dependencia-<BR><BR>POR FAVOR COMUNIQUESE CON EL ADMINISTRADOR DEL SISTEMA<BR>
   	<?
	}else{
	?>
	<BR>
