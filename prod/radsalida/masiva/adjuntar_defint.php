...
else
{
	...
	if ($extension  == 'odt') {
				...
				$accion = false;
				$odt = new OpenDocText();
                                $odt->carpetaBodega = $carpetaBodega;
...
//				$odt->borrar();
				...
				{	
					...
					echo "<BR><span class='info'><a  class='vinculos' href='$ruta_raiz/seguridadImagen.php?fec=".base64_encode(str_ireplace($carpetaBodega,"",$archivoF))."'>GuardarArchivo</a>"; 
		   			...
		   			echo "<BR><a class='vinculos' href='$ruta_raiz/seguridadImagen.php?fec=".base64_encode(substr($arcPDF,strpos($arcPDF,$carpetaBodega)+strlen($carpetaBodega)))."' target='_blank'> Abrir Listado</a>"; 
		   			echo "</span>"; 
