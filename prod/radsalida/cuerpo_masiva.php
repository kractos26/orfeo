<?php
//Programa que genera el listado de todos los grupos de masiva generados por la dependencia, que no han sido enviados y da la opción de 
//generar el envío respectivo
...
//variable con elementos de sesión
...
<?
	...
	//variable que indica la acción a ejecutar en el formulario
              ...
              <table width="100%" border="0" cellspacing="1" cellpadding="0">
                ...
                <td width="84%" height="20" class='listado2'>
                  ...
                  <select name="dep_sel" class="select" id="tipo_clase"  onChange = "cambioDependecia(this.value)"  >
                    <option selected value="99999">----- Todas las dependencias -----</option>
                    <?php
