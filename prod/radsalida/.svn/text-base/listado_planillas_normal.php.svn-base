<?
session_start();
if (!$no_planilla or intval($no_planilla) == 0) die ("<table class=borde_tab width='100%'><tr><td class=titulosError><center>Debe colocar un Numero de Planilla válido</center></td></tr></table>");
if($generar_listado)
{
	error_reporting(7);
	$ruta_raiz = "..";
...
<center><b>Se han Generado <?=$total_registros?> Registros para Imprimir en <?=$paginas?> Planillas. <br>
