...
function Header()
{
    ...
    $this->SetXY($l,20+$margen);
 	$this->Cell(472,14,'REMITENTE: SUPERINTENDENCIA DE SERVICIOS PUBLICOS DOMICILIARIOS',1,1,'L');
    $this->SetXY($l,34+$margen);
 	$this->Cell(472,13,'CRA 18 No. 84-35',1,1,'L');
    $this->SetXY($l,47+$margen);
 	$this->Cell(472,13,'CONTRATO 020-07 ',1,1,'L');
	$l = 500;
	$this->SetXY($l,20+$margen);
