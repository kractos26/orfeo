...
if($estado_sal==2)
  {
	...
	$dependencia_busq1= " and radi_nume_sal like '$dependencia%'";
	$dependencia_busq2= " and radi_nume_salida like '$dependencia%'";
  } 				
...
<tr>
    ...
    <td width='35%' >
   	 	<table width='100%' border='0' cellspacing='1' cellpadding='0'>
     		<tr> 
        		<td height="20" class="titulos2" >USUARIO </td>
        	</tr>
			<tr class="info">
    ...
    <td width='35%' >
   	 	<table width='100%' border='0' cellspacing='1' cellpadding='0'>
     		<tr> 
        		<td height="20" class="titulos2">DEPENDENCIA</td>
        	</tr>
			<tr class="info">
