...
function isDateDDMMYYYY( Txt ){
     ...
     if( trim( Txt.value )!= '' ){
   	...
   	if( val.length > 10 ){
        ...
        if(nroTokens != 3 ){
          alert("Formato Fecha No Válido, Inserte una de la forma  DD-MM-YYYY");
   	  res = 0;
   	  Txt.value=fecha;
   	  Txt.focus();
   	  return res;
  	...
  	obtenerToken(val,'-',0);
        ...
        ano   = token;;
          ...
          alert("El Día y Mes deben ser Númericos,Inserte una de la forma  DD-MM-YYYY");
   	  res = 0;
   	  Txt.value=fecha;
   	  Txt.focus();
   	  return res;
   	...
   	{ 
        ...
        if( ano<1870){ 
   	   ...
   	   Txt.focus();
           ...
           alert("Dia No Válido el año "+ ano + " es Bisiesto");
   	   res = 0;
   	   //Txt.value=fecha;
   	   Txt.focus();
   	}
