<?php
			...
			foreach($this->campos_vista as $campos_d)
			  {
				...
				$tabla_html .=  "<td width='$width' height='$row_height' bgcolor='#CCCCCC'><center>$campos_d</td>";
 ...
 $tabla_html .=  "<td  align=$align width=".$this->campos_width[$iii]." height=".$this->row_height.">$dato</td>";
