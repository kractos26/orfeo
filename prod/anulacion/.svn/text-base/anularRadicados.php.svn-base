...
if($depeBuscada and $depeBuscada != 0)
{
  $whereDependencia = " b.DEPE_CODI=$depeBuscada AND";
	...
	$campos_vista = array ("Dependencia","Radicado","Fecha de Solicitud", "Motivo Anulacion");
...
<TABLE width="100%" class='borde_tab' cellspacing="3">
  <TR>
    <TD height="30" valign="middle"   class='titulos5' align="center" colspan="2" >Documentos con solicitud de Anulaci&oacute;n</td></tr>
...
Centro de Administraci&oacute;n Documental";
	...
	?>
      <center>Ver Acta <a href='../seguridadImagen.php?fec=<?=  base64_encode($noArchivo)?>'>Acta No <?=$actaNo?> </a></center>
		<?
    exit;
}
}
