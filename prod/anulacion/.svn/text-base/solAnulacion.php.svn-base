...
$anulSql = "select motivo_anulacion_descrip as descrip, motivo_anulacion_codigo as id from motivo_anulacion";
$rs_motAnulacion = $db->conn->Execute($anulSql);
$slc_motAnulacion = $rs_motAnulacion->GetMenu2('slc_motAnulacion', false,'' ,false, true, "id='slc_motAnulacion' class='select' <option value=0> --Seleccione un motivo-- </OPTION>");
...
function Anular(tipoAnulacion)
{
	...
	return;
        ...
        /*
         * Validacion de Seleccion de un Motivo de anulacion - Ivan Dario Posada 
         */
        if(document.getElementById('slc_motAnulacion').value ==0)
        {
            alert ("Por favor seleccione un motivo de anulaci\xf3n");
            return;
        }
...
<table border=0 width=100% cellpadding="0" cellspacing="0">
	...
	<table BORDER=0 WIDTH=98% cellspace=1 align="center" class="borde_tab">
		<TR>
			...
			<td class="titulos4">
			 SOLICITAR ANULACI&Oacute;N DE DOCUMENTO<BR>
			</td>
		...
		<tr align="center">
			...
			<td colspan="4" class="celdaGris">
				<span class="leidos">
                                <br>Se solicita la anulaci&oacute;n de los radicados seleccionados.<br>
                                   
                                <br>
                                    Por favor seleccione y digite el motivo de la anulaci&oacute;n: </span> <?php echo $slc_motAnulacion; ?> 
                                </br>
                                <br>
