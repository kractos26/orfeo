<?
/**
 * AplIntegrada es la clase encargada de gestionar las operaciones y  los datos b�sicos referentes a una aplicaci�n integrada con Orfeo
...
/**
* Genera el javascript que ha de permitir llenar un combo con las plicaciones que un usuario puede o integrar a la hora de generar cierto tipo de radicacion
