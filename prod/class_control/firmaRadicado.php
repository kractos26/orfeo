...
/**
 * Esp es la clase encargada de gestionar las operaciones y los datos b�sicos referentes a la firma digital de un radicado
  ...
  */
  ...
  /** 
	...
	*/	
	...
	/** 
  	* Consulta si se ha solicitado firma digital de una usuario para un radicado espec�fico
	...
	* @return   boolean
	...
	/** 
  	...
  	* @return   Array con toda la informaci�n de la firma
  	*/
	function firmaId($id) {
		$retorno = true;
