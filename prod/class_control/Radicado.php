...
/**
 * Radicado es la clase encargada de gestionar la informaci�n referente a un radicado
...
/** 
* Retorna un string  con el dato correspondiente a la fecha de radicaci�n;  antes de invocar esta funci�n, se debe llamar a  radicado_codigo()
* @return   string
*/
