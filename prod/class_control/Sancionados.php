...
<?
/**
 * Sancionados es la clase encargada de gestionar las operaciones y los datos b�sicos referentes a la interfaz Orfeo-Sancionados
...
class Sancionados{
   ...
   */
	...
	*/
	...
	/** 
	* Carga los atributos de la clase con la informaci�n de sancionados exitente para un numero de radicado
	* @param	$radi	String Es el n�mero delradicado.
	* @return   void
	*/
...
{	switch ($this->cursor->driver)
	...
	/** 
     * Busca los campos de combinaci�n que ha de incluirse teniendo en cuenta la informaci�n de sanciondos  y los adiciona a los arreglos que ha de procesar luego la funci�n de  combinaci�n de correspondencia. Debe invocarse antes sancionadosRad()
