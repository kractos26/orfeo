...
/**
 * Departamento es la clase encargada de gestionar las operaciones y  los datos b�sicos referentes a un Departamento
...
{	//si se ingres� un par�metro v�lido
	...
	{	if (strpos($codigo,'-'))
		...
		{	$this->dpto_codi=rtrim($rs->fields['DPTO_CODI']);
			$this->dpto_nomb=rtrim($rs->fields['DPTO_NOMB']);
		}
	}
	else
	{
