<?php require_once("$ruta_raiz/include/db/ConnectionHandler.php");

/**
 * TipoDocumento es la clase encargada de gestionar las operaciones y los datos b�sicos referentes a un tipo de documento a anexar a un radicado
...
/** 
* Retorna el valor string correspondiente al atributo descripci�n del tipo de archivo a anexar
* @return   string
*/
...
*/
 ...
 /** 
  * Actualiza los atributos de la clase con los datos del tipo de documento a anexar correspondiente al  c�digo del registro que recibe como par�metros
  * @param	$codigo	int es el c�digo del registro
  */
