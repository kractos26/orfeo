...
/** DEFINICION DE VARIABLES ESTADISTICA
	...
	*/
	$tituloE[1] = "RADICACI&Oacute;N - CONSULTA DE RADICADOS POR USUARIO";
	$tituloE[2] = "RADICACI&Oacute;N - ESTAD&Iacute;STICAS POR MEDIO DE RECEPCI&Oacute;N-ENV&Iacute;O";
	$tituloE[3] = "RADICACI&Oacute;N - ESTAD&Iacute;STICAS DE MEDIO ENV&Iacute;O FINAL DE DOCUMENTOS";
	$tituloE[4] = "RADICACI&Oacute;N - ESTAD&Iacute;STICAS DE DIGITALIZACI&Oacute;N DE DOCUMENTOS";
	$tituloE[5] = "RADICADOS DE ENTRADA RECIBIDOS DEL &Aacute;REA DE CORRESPONDENCIA";
	...
	$tituloE[11] = "ESTAD&Iacute;STICAS DE DIGITALIZACI&Oacute;N";
	...
	$subtituloE[1] = "ORFEO - Generada el: " . date("Y/m/d H:i:s"). "\n Par&aacute;metros de Fecha: Entre $fecha_ini y $fecha_fin";
...
<table width="100%"  border="0" cellpadding="0" cellspacing="5" class="borde_tab">
  ...
  <tr>
    <td width="30%" class="titulos2">Tipo de Consulta / Estad&iacute;stica</td>
...
<?php
    ...
    if($usua_perm_estadistica>1 && $tipoEstadistica==15)  {
...
if($tipoEstadistica==1 or $tipoEstadistica==2 or $tipoEstadistica==3 or 
	...
	$tipoEstadistica==7 or $tipoEstadistica==11 or $tipoEstadistica==12 or $tipoEstadistica==15 or $ipoEstadistica=25)
{
?>
<tr id="cUsuario">
...
<tr>
  ...
  <?php if($tipoEstadistica==1 ){
      ?>
  <tr>
      <td class="titulos2" width="30%" height="40">Tramitados</td> 
      <td class="listado2"><select name="tramitado" class="select">
...
<?}
  if($tipoEstadistica==1 or $tipoEstadistica==2 or $tipoEstadistica==3 or 
  		...
  		$tipoEstadistica==11 or $tipoEstadistica==12 or $tipoEstadistica==14 or $tipoEstadistica==15)
  {
  ?>  
  <tr>
...
<?
$datosaenviar = "fechaf=$fechaf&tipoEstadistica=$tipoEstadistica&codus=$codus&krd=$krd&dependencia_busq=$dependencia_busq&ruta_raiz=$ruta_raiz&fecha_ini=$fecha_ini&fecha_fin=$fecha_fin&idSerie=$idSerie&tipoRadicado=$tipoRadicado&tipoDocumento=$tipoDocumento&tipoPQR=$tipoPQ&resol=".$resol;
