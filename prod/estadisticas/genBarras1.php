...
$graph->img->SetMargin(120,-20,210,210);

$graph->SetMarginColor('white'); 

// Setup title for graph
$graph->title->Set(utf8_decode($tituloGraph));
$graph->title->SetFont(FF_FONT2,FS_BOLD);
$graph->subtitle->Set(utf8_decode($notaSubtitulo));

// Setup X-axis.
$graph->xaxis->SetTitle(utf8_decode($nombXAxis));
...
$graph->yaxis->SetTitle(utf8_decode($nombYAxis),'center');
